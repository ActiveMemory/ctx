...
You have a task and you're wondering: should I throw more agents at it?
...
re-reading context. The wrong setup costs more than it saves.
...
conventions — all in one session. The agent builds a coherent mental
model and persists it as it goes.
...
merges. Research + implementation where one agent explores options
...
**Merge hell.** If you're spending more time resolving conflicts than
...
- **Start with one agent.** Only add parallelism when you've identified
...
- **The 3-4 agent ceiling is real.** Coordination overhead grows
  ...
  Beyond 4, you're managing agents more than doing work.
