...
const (
	...
	TextDescKeyHeadingCompleted         = "heading.completed"
	TextDescKeyHeadingArchivedTasks     = "heading.archived-tasks"
	TextDescKeyHeadingContext           = "heading.context"
	TextDescKeyHeadingLoopStart         = "heading.loop-start"
	TextDescKeyHeadingToolUsage         = "heading.tool-usage"
	TextDescKeyHeadingConversation      = "heading.conversation"
	TextDescKeyHeadingSessionJournal    = "heading.session-journal"
	TextDescKeyHeadingTopics            = "heading.topics"
	TextDescKeyHeadingPopularTopics     = "heading.popular-topics"
	TextDescKeyHeadingLongtailTopics    = "heading.longtail-topics"
	TextDescKeyHeadingKeyFiles          = "heading.key-files"
	TextDescKeyHeadingFrequentlyTouched = "heading.frequently-touched"
	TextDescKeyHeadingSingleSession     = "heading.single-session"
	TextDescKeyHeadingSessionTypes      = "heading.session-types"
	TextDescKeyHeadingSuggestions       = "heading.suggestions"
	TextDescKeyHeadingRecentSessions    = "heading.recent-sessions"
	TextDescKeyLabelHome                = "label.home"
	TextDescKeyLabelTopics              = "label.topics"
	TextDescKeyLabelFiles               = "label.files"
	TextDescKeyLabelTypes               = "label.types"
	...
	TextDescKeyLabelMetaID       = "label.meta-id"
	TextDescKeyLabelMetaDate     = "label.meta-date"
	TextDescKeyLabelMetaTime     = "label.meta-time"
	TextDescKeyLabelMetaDuration = "label.meta-duration"
	TextDescKeyLabelMetaTool     = "label.meta-tool"
	TextDescKeyLabelMetaProject  = "label.meta-project"
	TextDescKeyLabelMetaBranch   = "label.meta-branch"
	TextDescKeyLabelMetaModel    = "label.meta-model"
	TextDescKeyLabelMetaTurns    = "label.meta-turns"
	TextDescKeyLabelMetaTokens   = "label.meta-tokens"
	TextDescKeyLabelMetaParts    = "label.meta-parts"

	// Role labels (headings.yaml).
	TextDescKeyLabelRoleUser      = "label.role-user"
	TextDescKeyLabelRoleAssistant = "label.role-assistant"

	// Column headers (headings.yaml).
	TextDescKeyLabelColSlug     = "label.col-slug"
	TextDescKeyLabelColProject  = "label.col-project"
	TextDescKeyLabelColDate     = "label.col-date"
	TextDescKeyLabelColDuration = "label.col-duration"
	TextDescKeyLabelColTurns    = "label.col-turns"
	TextDescKeyLabelColTokens   = "label.col-tokens"

	// Section headers (headings.yaml).
	TextDescKeyLabelSectionToolUsage           = "label.section-tool-usage"
	TextDescKeyLabelSectionConversation        = "label.section-conversation"
	TextDescKeyLabelSectionConversationPreview = "label.section-conversation-preview"

	// Hints and markers (headings.yaml).
	TextDescKeyLabelHintUseFull        = "label.hint-use-full"
	TextDescKeyLabelHintUseAllProjects = "label.hint-use-all-projects"
	TextDescKeyLabelInlineTool         = "label.inline-tool"
	TextDescKeyLabelInlineError        = "label.inline-error"
	...
	TextDescKeyLabelReasonExists       = "label.reason-exists"
	TextDescKeyLabelReasonUpdated      = "label.reason-updated"
	TextDescKeyLabelLoopComplete       = "label.loop-complete"

	// Obsidian vault headings and labels (headings.yaml).
	TextDescKeyHeadingObsidianRelated = "heading.obsidian-related"
	TextDescKeyLabelObsidianSeeAlso   = "label.obsidian-see-also"

	// Config file pattern topics for ctx sync (headings.yaml).
	TextDescKeySyncTopicEslint       = "sync.topic.eslint"
	TextDescKeySyncTopicPrettier     = "sync.topic.prettier"
	TextDescKeySyncTopicTSConfig     = "sync.topic.tsconfig"
	TextDescKeySyncTopicEditorConfig = "sync.topic.editorconfig"
	TextDescKeySyncTopicMakefile     = "sync.topic.makefile"
	TextDescKeySyncTopicDockerfile   = "sync.topic.dockerfile"
)
