...
func renderRow(row Row) string {
	...
	sb.WriteString(escapeCell(row.ShortName))
	sb.WriteString(marker.TableCellSep)
	sb.WriteString(escapeCell(row.Kind))
	sb.WriteString(marker.TableCellSep)
	sb.WriteString(escapeCell(row.Locator))
	sb.WriteString(marker.TableCellSep)
	sb.WriteString(escapeCell(row.AdmissionStatus))
	sb.WriteString(marker.TableCellSep)
	sb.WriteString(escapeCell(row.AdmissionRationale))
	sb.WriteString(marker.TableCellSep)
	sb.WriteString(escapeCell(row.Dated))
