...
func InfoOverwritePrompt(cmd *cobra.Command, contextDir string) {
	cmd.Print(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitOverwritePrompt), contextDir))
}
...
func InfoAborted(cmd *cobra.Command) {
	cmd.Println(desc.TextDesc(text.TextDescKeyWriteInitAborted))
}
...
func InfoExistsSkipped(cmd *cobra.Command, name string) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitExistsSkipped), name))
}
...
func InfoFileCreated(cmd *cobra.Command, name string) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitFileCreated), name))
}
...
func InfoInitialized(cmd *cobra.Command, contextDir string) {
	cmd.Println()
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitialized), contextDir))
}
...
func InfoWarnNonFatal(cmd *cobra.Command, label string, err error) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitWarnNonFatal), label, err))
}
...
func InfoScratchpadPlaintext(cmd *cobra.Command, path string) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitScratchpadPlaintext), path))
}
...
func InfoScratchpadNoKey(cmd *cobra.Command, keyPath string) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitScratchpadNoKey), keyPath))
}
...
func InfoScratchpadKeyCreated(cmd *cobra.Command, keyPath string) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitScratchpadKeyCreated), keyPath))
}
...
func InfoCreatingRootFiles(cmd *cobra.Command) {
	cmd.Println()
	cmd.Println(desc.TextDesc(text.TextDescKeyWriteInitCreatingRootFiles))
}
...
func InfoSettingUpPermissions(cmd *cobra.Command) {
	cmd.Println()
	cmd.Println(desc.TextDesc(text.TextDescKeyWriteInitSettingUpPermissions))
}
...
func InfoGitignoreUpdated(cmd *cobra.Command, count int) {
	cmd.Println(fmt.Sprintf(desc.TextDesc(text.TextDescKeyWriteInitGitignoreUpdated), count))
}
...
func InfoGitignoreReview(cmd *cobra.Command) {
	cmd.Println(desc.TextDesc(text.TextDescKeyWriteInitGitignoreReview))
}
...
func InfoNextSteps(cmd *cobra.Command) {
	cmd.Println(desc.TextDesc(text.TextDescKeyWriteInitNextStepsBlock))
}
