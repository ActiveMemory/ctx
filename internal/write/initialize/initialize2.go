...
func InfoOverwritePrompt(cmd *cobra.Command, contextDir string) {
	cmd.Print(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitOverwritePrompt), contextDir))
}
...
func InfoAborted(cmd *cobra.Command) {
	cmd.Println(assets.TextDesc(embed.TextDescKeyWriteInitAborted))
}
...
func InfoExistsSkipped(cmd *cobra.Command, name string) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitExistsSkipped), name))
}
...
func InfoFileCreated(cmd *cobra.Command, name string) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitFileCreated), name))
}
...
func InfoInitialized(cmd *cobra.Command, contextDir string) {
	cmd.Println()
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitialized), contextDir))
}
...
func InfoWarnNonFatal(cmd *cobra.Command, label string, err error) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitWarnNonFatal), label, err))
}
...
func InfoScratchpadPlaintext(cmd *cobra.Command, path string) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitScratchpadPlaintext), path))
}
...
func InfoScratchpadNoKey(cmd *cobra.Command, keyPath string) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitScratchpadNoKey), keyPath))
}
...
func InfoScratchpadKeyCreated(cmd *cobra.Command, keyPath string) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitScratchpadKeyCreated), keyPath))
}
...
func InfoCreatingRootFiles(cmd *cobra.Command) {
	cmd.Println()
	cmd.Println(assets.TextDesc(embed.TextDescKeyWriteInitCreatingRootFiles))
}
...
func InfoSettingUpPermissions(cmd *cobra.Command) {
	cmd.Println()
	cmd.Println(assets.TextDesc(embed.TextDescKeyWriteInitSettingUpPermissions))
}
...
func InfoGitignoreUpdated(cmd *cobra.Command, count int) {
	cmd.Println(fmt.Sprintf(assets.TextDesc(embed.TextDescKeyWriteInitGitignoreUpdated), count))
}
...
func InfoGitignoreReview(cmd *cobra.Command) {
	cmd.Println(assets.TextDesc(embed.TextDescKeyWriteInitGitignoreReview))
}
...
func InfoNextSteps(cmd *cobra.Command) {
	cmd.Println(assets.TextDesc(embed.TextDescKeyWriteInitNextStepsBlock))
}
