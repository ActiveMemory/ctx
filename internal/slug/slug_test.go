...
func TestPath(t *testing.T) {
	tests := []struct {
		...
		{"empty", "", ""},
		{"plain word", "cursor", "cursor"},
		{"two words become hyphen", "Cursor Hooks", "cursor-hooks"},
		{
			"vendor slash topic preserved",
			"cursor/hooks", "cursor/hooks",
		},
		{
			"vendor slash topic with spaces",
			"cursor / hooks", "cursor-/-hooks",
		},
		{
			"strips punctuation but keeps slash",
			"Cursor: Hooks!", "cursor-hooks",
		},
		{"trims leading slash", "/cursor/hooks", "cursor/hooks"},
		{"trims trailing slash", "cursor/hooks/", "cursor/hooks"},
		{
			"trims surrounding hyphens",
			"---cursor---", "cursor",
		},
		{"unicode falls out", "café", "caf"},
