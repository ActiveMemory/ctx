...
func FormatSessionMatchLines(matches []*entity.Session) []string {
...
func FormatJournalFilename(s *entity.Session, slugOverride string) string {
...
func FormatToolUse(t entity.ToolUse) string {
