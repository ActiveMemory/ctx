...
// Package recall provides CLI commands for browsing and searching
// AI session history.
//
// The recall system parses JSONL session files from various AI
// coding assistants (currently Claude Code) and provides commands
// to list, view, and export sessions.
//
// Commands:
